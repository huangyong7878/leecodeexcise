 ...
 * maximum values of each subarray of length k.<BR>
 *
 * For example, given array = [10, 5, 2, 7, 8, 7] and k = 3, we should get: [10, 7, 8, 8],
 * since:<BR>
 *
 * 10 = max(10, 5, 2)<BR> 7 = max(5, 2, 7)<BR> 8 = max(2, 7, 8)<BR> 8 = max(7, 8, 7)<BR> Do this in
 * O(n) time and O(k) space. You can modify the input array in-place and you do not need to store
